...
const uint16_t kAiwaRcT501MinRepeats = 1;//kSingleRepeat;
const uint16_t kArgoStateLength = 12;
const uint16_t kArgoDefaultRepeat = 0;//kNoRepeat;
const uint16_t kCoolixBits = 24;
const uint16_t kCoolixDefaultRepeat = 1;
const uint16_t kCarrierAcBits = 32;
const uint16_t kCarrierAcMinRepeat = 0;//kNoRepeat;
const uint16_t kDaikinStateLength = 35;
const uint16_t kDaikinBits = 35*8;//kDaikinStateLength * 8;
const uint16_t kDaikinStateLengthShort = 35-8;//kDaikinStateLength - 8;
const uint16_t kDaikinBitsShort = (35-8)*8;//kDaikinStateLengthShort * 8;
const uint16_t kDaikinDefaultRepeat = 0;//kNoRepeat;
const uint16_t kDaikin2StateLength = 39;
const uint16_t kDaikin2Bits = 39*8;// kDaikin2StateLength * 8;
const uint16_t kDaikin2DefaultRepeat = 0;//kNoRepeat;
const uint16_t kDaikin216StateLength = 27;
const uint16_t kDaikin216Bits = 27*8;//kDaikin216StateLength * 8;
const uint16_t kDaikin216DefaultRepeat = 0;//kNoRepeat;
const uint16_t kDenonBits = 15;
const uint16_t kDenonLegacyBits = 14;
const uint16_t kDishBits = 16;
const uint16_t kDishMinRepeat = 3;
const uint16_t kElectraAcStateLength = 13;
const uint16_t kElectraAcBits = 13*8;//kElectraAcStateLength * 8;
const uint16_t kFujitsuAcMinRepeat = 0;//kNoRepeat;
const uint16_t kFujitsuAcStateLength = 16;
const uint16_t kFujitsuAcStateLengthShort = 7;
const uint16_t kFujitsuAcBits = 16*8;//kFujitsuAcStateLength * 8;
const uint16_t kFujitsuAcMinBits = (7-1)*8;// (kFujitsuAcStateLengthShort - 1) * 8;
const uint16_t kGicableBits = 16;
const uint16_t kGicableMinRepeat = 1;//kSingleRepeat;
const uint16_t kGreeStateLength = 8;
const uint16_t kGreeBits = 8*8;//kGreeStateLength * 8;
const uint16_t kGreeDefaultRepeat = 0;//kNoRepeat;
const uint16_t kHaierACStateLength = 9;
const uint16_t kHaierACBits = 9*8;//kHaierACStateLength * 8;
const uint16_t kHaierAcDefaultRepeat = 0;//kNoRepeat;
const uint16_t kHaierACYRW02StateLength = 14;
const uint16_t kHaierACYRW02Bits = 14*8;//kHaierACYRW02StateLength * 8;
const uint16_t kHaierAcYrw02DefaultRepeat = 0;//kNoRepeat;
const uint16_t kHitachiAcStateLength = 28;
const uint16_t kHitachiAcBits = 28*8;//kHitachiAcStateLength * 8;
const uint16_t kHitachiAcDefaultRepeat = 0;//kNoRepeat;
const uint16_t kHitachiAc1StateLength = 13;
const uint16_t kHitachiAc1Bits = 13*8;//kHitachiAc1StateLength * 8;
const uint16_t kHitachiAc2StateLength = 53;
const uint16_t kHitachiAc2Bits = 53*8;//kHitachiAc2StateLength * 8;
const uint16_t kJvcBits = 16;
const uint16_t kKelvinatorStateLength = 16;
const uint16_t kKelvinatorBits = 16*8;//kKelvinatorStateLength * 8;
const uint16_t kKelvinatorDefaultRepeat = 0;//kNoRepeat;
const uint16_t kLasertagBits = 13;
const uint16_t kLasertagMinRepeat = 0;//kNoRepeat;
const uint16_t kLegoPfBits = 16;
const uint16_t kLegoPfMinRepeat = 0;//kNoRepeat;
...
const uint16_t kMideaMinRepeat = 0;//kNoRepeat;
...
const uint16_t kMitsubishiMinRepeat = 1;//kSingleRepeat;
const uint16_t kMitsubishiACStateLength = 18;
const uint16_t kMitsubishiACBits = 18*8;//kMitsubishiACStateLength * 8;
const uint16_t kMitsubishiACMinRepeat = 1;//kSingleRepeat;
const uint16_t kMitsubishiHeavy88StateLength = 11;
const uint16_t kMitsubishiHeavy88Bits = 11*8;//kMitsubishiHeavy88StateLength * 8;
const uint16_t kMitsubishiHeavy88MinRepeat = 0;//kNoRepeat;
const uint16_t kMitsubishiHeavy152StateLength = 19;
const uint16_t kMitsubishiHeavy152Bits = 19*8;//kMitsubishiHeavy152StateLength * 8;
const uint16_t kMitsubishiHeavy152MinRepeat = 0;//kNoRepeat;
...
const uint16_t kPanasonicAcBits = 27*8;//kPanasonicAcStateLength * 8;
const uint16_t kPanasonicAcShortBits = 16*8;//kPanasonicAcStateShortLength * 8;
const uint16_t kPanasonicAcDefaultRepeat = 0;//kNoRepeat;
const uint16_t kPioneerBits = 64;
const uint16_t kProntoMinLength = 6;
const uint16_t kRC5RawBits = 14;
const uint16_t kRC5Bits =14-2;// kRC5RawBits - 2;
const uint16_t kRC5XBits = 14-1;//kRC5RawBits - 1;
...
const uint16_t kSamsungAcBits = 14*8;//kSamsungAcStateLength * 8;
const uint16_t kSamsungAcExtendedStateLength = 21;
const uint16_t kSamsungAcExtendedBits = 21*8;//kSamsungAcExtendedStateLength * 8;
const uint16_t kSamsungAcDefaultRepeat = 0;//kNoRepeat;
const uint16_t kSanyoSA8650BBits = 12;
const uint16_t kSanyoLC7461AddressBits = 13;
const uint16_t kSanyoLC7461CommandBits = 8;
const uint16_t kSanyoLC7461Bits = (13+8)*2;//(kSanyoLC7461AddressBits +
                                   //kSanyoLC7461CommandBits) * 2;
const uint8_t  kSharpAddressBits = 5;
const uint8_t  kSharpCommandBits = 8;
const uint16_t kSharpBits = 5+8+2;//kSharpAddressBits + kSharpCommandBits + 2;  // 15
const uint16_t kSharpAcStateLength = 13;
const uint16_t kSharpAcBits = 13*8;//kSharpAcStateLength * 8;  // 104
const uint16_t kSharpAcDefaultRepeat = 0;//kNoRepeat;
const uint8_t  kSherwoodBits = 32;//kNECBits;
const uint16_t kSherwoodMinRepeat = 1;//kSingleRepeat;
...
const uint16_t kTcl112AcBits = 14*8;//kTcl112AcStateLength * 8;
const uint16_t kTcl112AcDefaultRepeat = 0;//kNoRepeat;
const uint16_t kTecoBits = 35;
const uint16_t kTecoDefaultRepeat = 0;//kNoRepeat;
const uint16_t kToshibaACStateLength = 9;
const uint16_t kToshibaACBits = 9*8;//kToshibaACStateLength * 8;
const uint16_t kToshibaACMinRepeat = 1;//kSingleRepeat;
const uint16_t kTrotecStateLength = 9;
const uint16_t kTrotecDefaultRepeat = 0;//kNoRepeat;
const uint16_t kWhirlpoolAcStateLength = 21;
const uint16_t kWhirlpoolAcBits = 21*8;//kWhirlpoolAcStateLength * 8;
const uint16_t kWhirlpoolAcDefaultRepeat = 0;//kNoRepeat;
